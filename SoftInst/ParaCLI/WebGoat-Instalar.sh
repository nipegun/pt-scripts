...
#   curl -sL https://raw.githubusercontent.com/nipegun/dh-scripts/refs/heads/master/SoftInst/ParaCLI/WebGoat-Instalar.sh | bash
#
# Ejecución remota como root (para sistemas sin sudo):
#   curl -sL https://raw.githubusercontent.com/nipegun/dh-scripts/refs/heads/master/SoftInst/ParaCLI/WebGoat-Instalar.sh | sed 's-sudo--g' | bash
#
