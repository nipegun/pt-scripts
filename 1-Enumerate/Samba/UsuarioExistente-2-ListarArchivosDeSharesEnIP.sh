...
#   curl -sL https://raw.githubusercontent.com/nipegun/pt-scripts/refs/heads/main/1-Enumerate/Samba/UsuarioExistente-2-ListarArchivosDeSharesEnIP.sh | bash -s 'IPServSamba' 'UsuarioExistente' 'Contraseña'
#
# Ejecución remota como root (para sistemas sin sudo):
#   curl -sL https://raw.githubusercontent.com/nipegun/pt-scripts/refs/heads/main/1-Enumerate/Samba/UsuarioExistente-2-ListarArchivosDeSharesEnIP.sh | sed 's-sudo--g' | bash -s 'IPServSamba' 'UsuarioExistente' 'Contraseña'
#
# Bajar y editar directamente el archivo en nano
#   curl -sL https://raw.githubusercontent.com/nipegun/pt-scripts/refs/heads/main/1-Enumerate/Samba/UsuarioExistente-2-ListarArchivosDeSharesEnIP.sh | nano -
# ----------
