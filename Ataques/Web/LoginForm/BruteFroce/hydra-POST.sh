...
#   curl -sL https://raw.githubusercontent.com/nipegun/dh-scripts/refs/heads/main/WordLists/EnTextoPlano-Instalar.sh | bash -s '10.10.179.150' '/login' 'molly' '/home/user/Downloads/rockyou.txt''
#
