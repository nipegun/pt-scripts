...
# HTML que se devuelve en caso de credenciales correctas
html_correcta = """
<!DOCTYPE html>
<html>
<head>
...
class SimpleHTTPRequestHandler(http.server.BaseHTTPRequestHandler):
    def do_POST(self):
        # Obtenemos el tamaño del contenido y leemos los datos enviados
    ...
    def do_GET(self):
        # Para cualquier solicitud GET, se indica que se debe usar POST
        self.send_response(400)
        self.send_header('Content-Type', 'application/json')
        self.end_headers()
...
if __name__ == "__main__":
    server_address = ('', 5000)  # Escucha en todas las interfaces en el puerto 5000
