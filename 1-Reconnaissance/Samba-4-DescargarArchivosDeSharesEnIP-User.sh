...
#   curl -sL https://raw.githubusercontent.com/nipegun/dh-scripts/refs/heads/main/1-Reconnaissance/Samba-3-DescargarArchivosDeSharesEnIP-User.sh | bash -s 'IPServSamba' 'Usuario' 'Password'
#
# Ejecución remota como root (para sistemas sin sudo):
#   curl -sL https://raw.githubusercontent.com/nipegun/dh-scripts/refs/heads/main/1-Reconnaissance/Samba-3-DescargarArchivosDeSharesEnIP-User.sh | sed 's-sudo--g' | bash -s 'IPServSamba' 'Usuario' 'Password'
#
# Bajar y editar directamente el archivo en nano
#   curl -sL https://raw.githubusercontent.com/nipegun/dh-scripts/refs/heads/main/1-Reconnaissance/Samba-3-DescargarArchivosDeSharesEnIP-User.sh | nano -
# ----------
