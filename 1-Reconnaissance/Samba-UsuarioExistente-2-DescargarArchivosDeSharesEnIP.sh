...
#   curl -sL https://raw.githubusercontent.com/nipegun/dh-scripts/refs/heads/main/1-Reconnaissance/Samba-UsuarioExistente-2-DescargarArchivosDeSharesEnIP.sh | bash -s 'IPServSamba' 'UsuarioExistente' 'Contraseña'
#
# Ejecución remota como root (para sistemas sin sudo):
#   curl -sL https://raw.githubusercontent.com/nipegun/dh-scripts/refs/heads/main/1-Reconnaissance/Samba-UsuarioExistente-2-DescargarArchivosDeSharesEnIP.sh | sed 's-sudo--g' | bash -s 'IPServSamba' 'UsuarioExistente' 'Contraseña'
#
# Bajar y editar directamente el archivo en nano
#   curl -sL https://raw.githubusercontent.com/nipegun/dh-scripts/refs/heads/main/1-Reconnaissance/Samba-UsuarioExistente-2-DescargarArchivosDeSharesEnIP.sh | nano -
# ----------
...
# Descargar contenido de cada share
  for vNombreDelShare in "${aSharesEncontrados[@]}"; do
    ...
    smbclient "//$vIPServSamba/$vNombreDelShare" -N -c "lcd Share-$vNombreDelShare/$vUsuarioExistente; recurse; prompt; mget *.*"
  done
