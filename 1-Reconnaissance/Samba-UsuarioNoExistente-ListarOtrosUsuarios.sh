...
#   curl -sL https://raw.githubusercontent.com/nipegun/dh-scripts/refs/heads/main/1-Reconnaissance/Samba-UsuarioNoExistente-ListarOtrosUsuarios.sh | bash -s 'IPServSamba' 'UsuarioNoExistente'
#
# Ejecución remota como root (para sistemas sin sudo):
#   curl -sL https://raw.githubusercontent.com/nipegun/dh-scripts/refs/heads/main/1-Reconnaissance/Samba-UsuarioNoExistente-ListarOtrosUsuarios.sh | sed 's-sudo--g' | bash -s 'IPServSamba' 'UsuarioNoExistente'
#
