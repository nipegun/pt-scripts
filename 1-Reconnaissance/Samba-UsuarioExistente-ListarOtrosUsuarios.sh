...
#   curl -sL https://raw.githubusercontent.com/nipegun/dh-scripts/refs/heads/main/1-Reconnaissance/Samba-UsuarioExistente-ListarOtrosUsuarios.sh | bash -s 'IPServSamba' 'UsuarioExistente' 'PassDelUsuario'
#
# Ejecución remota como root (para sistemas sin sudo):
#   curl -sL https://raw.githubusercontent.com/nipegun/dh-scripts/refs/heads/main/1-Reconnaissance/Samba-UsuarioExistente-ListarOtrosUsuarios.sh | sed 's-sudo--g' | bash -s 'IPServSamba' 'UsuarioExistente' 'PassDelUsuario'
#
# Bajar y editar directamente el archivo en nano
#   curl -sL https://raw.githubusercontent.com/nipegun/dh-scripts/refs/heads/main/1-Reconnaissance/Samba-UsuarioExistente-ListarOtrosUsuarios.sh | nano -
# ----------
